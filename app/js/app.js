angular.module('fleetonrails', ['ngRoute','ngAnimate','n3-pie-chart','base64',
    ...
    config(['$routeProvider', function ($routeProvider) {
        $routeProvider.
            ...
            when('/vendors/:id/add_product',{templateUrl:'partials/addProduct.html',controller:'vendorProductsCtrl'}).
            ...
            when('/group/:id/car/:car_id/expense/:expense_id',{templateUrl:'partials/expenseedit.html',controller:'groupCarExpenseEditCtrl'}).
